 ...
 * 
 */
public class ChecksummerFactoryHelper {
    private static final Logger logger = LoggerFactory.getLogger(ChecksummerFactoryHelper.class);

    public final static PageChecksummerConfiguration cfg = new PageChecksummerConfiguration();
