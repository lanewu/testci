...
import py.netty.core.nio.SelectedSelectionKeySet;
import py.netty.core.nio.SelectedSelectionKeySetSelector;
...
/**
 * This class is duplicated from NioEventLoop (version 4.1.19). The reason to copy from NioEventLoop instead of 
 * inheriting from it is NioEventLoop is a final class :(
 * 
 * @author chenlia
 */
public final class MyEventLoop extends SingleThreadEventLoop {
    ...
    /**
     * Returns the {@link SelectorProvider} used by this {@link MyEventLoop} to obtain the {@link Selector}.
     */
