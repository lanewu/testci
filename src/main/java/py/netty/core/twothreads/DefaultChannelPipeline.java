...
public class DefaultChannelPipeline implements ChannelPipeline {
    ...
    public final ChannelPipeline fireChannelReadComplete() {
        // temporarily disable readComplete because it will eventually call AbstractChannel.read() which puts a task
        // to the task engine and wake up socket selection.
//        AbstractChannelHandlerContext.invokeChannelReadComplete(head);
    ...
    protected void incrementPendingOutboundBytes(long size) {
        AbstractChannel.AbstractUnsafe abstractUnsafe = (AbstractChannel.AbstractUnsafe) channel.unsafe();
