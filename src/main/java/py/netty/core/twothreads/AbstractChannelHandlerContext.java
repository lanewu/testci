...
abstract class AbstractChannelHandlerContext extends DefaultAttributeMap
    ...
    private final static Logger logger = LoggerFactory.getLogger(AbstractChannelHandlerContext.class);
    ...
    /**
     * Neither {@link ChannelHandler#handlerAdded(ChannelHandlerContext)} nor {@link
    ...
    AbstractChannelHandlerContext(DefaultChannelPipeline pipeline, EventExecutor executor, String name, boolean inbound,
            boolean outbound) {
            ...
            try {
                ...
                if (logger.isDebugEnabled()) {
                    logger.debug("An exception {}" + "was thrown by a user handler's exceptionCaught() "
                                    + "method while handling the following exception:", ThrowableUtil.stackTraceToString(error),
                            cause);
    ...
    @Override
    /**
     * make the task thread to execute the read() which does nothing but
     */ public ChannelHandlerContext read() {
        ...
        if (eventLoop.inTaskThread()) {
            ...
            // autoread is set, someone call it
    ...
    abstract static class AbstractWriteTask implements Runnable {
        ...
        protected static PYMetric timerFlush;
        protected static PYMetric timerWrite;
        ...
        static {
            ...
            timerFlush = metricRegistry
                    .register(MetricRegistry.name(WriteAndFlushTask.class.getSimpleName(), "timer_flush"), Timer.class);
            timerWrite = metricRegistry
                    .register(MetricRegistry.name(WriteTask.class.getSimpleName(), "timer_write"), Timer.class);
        }
...
//                assert msg instanceof MetricMessage;

//                ((MetricMessage) msg).stopTimer(MetricMessage.TIMER_IN_TASK_QUEUE);
//                write(ctx, ((MetricMessage) msg).getData(), promise);
    ...
    static final class WriteAndFlushTask extends AbstractWriteTask {
        ...
        public void write(AbstractChannelHandlerContext ctx, Object msg, ChannelPromise promise) {
            ...
            PYTimerContext context = timerFlush.time();
            ctx.invokeFlush();
            context.stop();
        }
    }
