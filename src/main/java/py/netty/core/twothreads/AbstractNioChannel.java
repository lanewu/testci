...
/**
 * This class is duplicated from AbstractNioChannel (4.1.19)
 *
 * @author chenlia
 */
...
public abstract class AbstractNioChannel extends AbstractChannel {
    ...
    protected abstract class AbstractNioUnsafe extends AbstractUnsafe implements NioUnsafe {
        ...
        public final void finishConnect() {
            ...
            // finishConnect() is being executed by the reader thread
    ...
    protected void doBeginRead() throws Exception {
        ...
        try {
            ...
            // once the selector is waken up, we have to call waitSelectorDone.
            // therefore, putting eventLoop().waitSelectorDone() in the finally block is to ensure it in the case of throwing exceptions between wakeupsSelector and clientWaitOnBarrier
            eventLoop().waitSelectorDone();
        }
    }
    ...
    /**
     * Returns an off-heap copy of the specified {@link ByteBuf}, and releases the original one. Note that this method
     * does not create an off-heap copy if the allocation / deallocation cost is too high, but just returns the original
     * {@link ByteBuf}..
     */
    ...
    /**
     * Returns an off-heap copy of the specified {@link ByteBuf}, and releases the specified holder. The caller must
     * ensure that the holder releases the original {@link ByteBuf} when the holder is released by this method. Note
     * that this method does not create an off-heap copy if the allocation / deallocation cost is too high, but just
     * returns the original {@link ByteBuf}..
     */
