...
//        reportLeak();
    ...
    @SuppressWarnings("deprecation")
    private static final class DefaultResourceLeak<T> implements ResourceLeakTracker<T>, ResourceLeak {
        ...
        public boolean close(T trackedObject) {
            ...
            logger.debug("The tractedObject {} is closed, id {}", trackedObject, trackedHash, new Throwable());
            return true;
        }
