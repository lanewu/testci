...
public class FileUtils {
    ...
    /**
     * If you're using an operating system that supports the proc filesystem, this returns a list of all processes by
     * reading the directories under /proc
     *
     ...
     * @throws IOException
     *             If there's an IO exception while trying to read the file
     */
     ...
     * @throws IOException
     *             If there's an IO exception while trying to read the input stream
     */
    ...
    /**
     * Give a symbolic path and get its real path.
     * 
     * @param link
     *            symbolic path
     * @return real path of the given symbolic path
     * @throws IOException
     */
    ...
    /**
     * Count total number of sub-files (including directories) on one level of the given directory.
     * 
     * @param directory
     *            target directory.
     * @return total number of sub-files (including directories) on one level of the given directory.
     * @throws IOException
     */
