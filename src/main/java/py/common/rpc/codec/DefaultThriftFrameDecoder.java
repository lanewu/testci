...
import py.common.rpc.server.TNiftyTransport;
...
public class DefaultThriftFrameDecoder extends ThriftFrameDecoder
{
    ...
    private final static Logger logger = LoggerFactory.getLogger(DefaultThriftFrameDecoder.class);
                                                   ...
                                                   boolean stripFraming)
    {
        ...
        if (messageContentsLength > maxFrameSize) {
            logger.error("message length is more than maxFrameSize: message lenght {}, maxFrameSize {}", messageContentsLength, maxFrameSize);
